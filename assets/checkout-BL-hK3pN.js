import{c as y,d as h,p as x,f as p,g as w,i as C,b as S}from"./breadcrumb-B5fJoev5.js";const $=h();function E(){let i="";const d=y($);Object.values(d).forEach(s=>{const l=s.productId,c=x.find(n=>n.id===l);c&&(i+=`
