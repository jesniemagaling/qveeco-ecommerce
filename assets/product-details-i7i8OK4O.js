import{i as p,p as b,b as g,a as f,s as y,g as x,f as m}from"./emailHandler-OspaDWTX.js";import{c as v}from"./formatter-byuH9jKl.js";const c="/qveeco-ecommerce/assets/images";function w(e){return`
  ...
  `}let d=2;document.addEventListener("DOMContentLoaded",()=>{p();const e=C(),t=b.find(o=>o.id===e);t&&(d=2,g(".breadcrumbs ul",[{label:"Home",href:"qveeco.html"},{label:"Products",href:"category.html"},{label:v(t.type||"Product")}]),k(t),S(),B(),u())});function C(){return new URLSearchParams(window.location.search).get("id")}function k(e){const t=document.getElementById("productContainer");t&&(t.innerHTML=w(e),h(e))}function h(e){const t=document.getElementById("productRatingContainer"),o=document.getElementById("ratingLoadMoreBtn");if(!t||!o)return;t.innerHTML="";const n=e.reviews||[];n.forEach((a,s)=>{const r=document.createElement("article");r.classList.add("review-item"),s>=d&&r.classList.add("hidden"),r.innerHTML=`
    ...
    `,t.appendChild(r)}),o.classList.toggle("hidden",n.length<=d),o.onclick=()=>{d=n.length,h(e)}}function S(){const e=document.getElementById("addToCartBtn"),t=document.getElementById("itemCount");if(!e||!t)return;let o=1;e.addEventListener("click",()=>{const s=e.dataset.productId,r=o,i=document.querySelector('input[name="size"]:checked');if(!i){alert("Please select a size before adding to cart.");return}const l=i.value;f({productId:s,size:l,quantity:r}),y("Item added successfully."),u(),o=1,t.textContent="1",i.checked=!1});const n=document.getElementById("minusBtn"),a=document.getElementById("addBtn");n?.addEventListener("click",()=>{o>1&&(o--,t.textContent=o)}),a?.addEventListener("click",()=>{o++,t.textContent=o})}function u(){JSON.parse(localStorage.getItem("cart"));const e=x(),t=e===0?13:e;document.getElementById("cartCount").textContent=t}function B(){const e=[{btn:"productDetailsBtn",section:"productDetails"},{btn:"productRatingsBtn",section:"productRatings"},{btn:"productFAQBtn",section:"productFAQ"}];e.forEach(({btn:n,section:a})=>{const s=document.getElementById(n),r=document.getElementById(a);s&&r&&s.addEventListener("click",()=>{e.forEach(({btn:i,section:l})=>{document.getElementById(i).classList.remove("border-b-black","text-black","font-medium"),document.getElementById(i).classList.add("border-b-transparent","text-black/60"),document.getElementById(l).classList.add("hidden")}),s.classList.add("border-b-black","text-black","font-medium"),s.classList.remove("border-b-transparent","text-black/60"),r.classList.remove("hidden")})}),document.getElementById("productDetailsBtn")?.click();const t=document.getElementById("faqLoadMoreBtn"),o=document.getElementById("faqMoreContent");t?.addEventListener("click",()=>{o?.classList.remove("hidden"),t.classList.add("hidden")})}document.querySelector('[data-dismiss-target="#toast-success"]')?.addEventListener("click",()=>{document.getElementById("toast-success")?.classList.add("hidden")});export{C as g};
