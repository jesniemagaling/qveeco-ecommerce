import{c as x,p,f as u,d as f,s as m,g,i as y,b}from"./breadcrumb-B8B7WBGj.js";import{c as v}from"./formatter-byuH9jKl.js";const h=f();function r(){let t=0,c="";const e=x(h);Object.values(e).forEach(s=>{const n=s.productId,a=p.find(o=>o.id===n);if(a){const o=a.priceCents*s.quantity;t+=o,c+=`
