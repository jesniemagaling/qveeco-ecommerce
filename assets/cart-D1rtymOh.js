import{c as x,p as g,f as m,d as p,s as u,g as y,i as b,b as v}from"./emailHandler-BFc5NzdT.js";import{c as h}from"./formatter-byuH9jKl.js";const f="/qveeco-ecommerce/assets/images",$=p();function r(){let t=0,a="";const e=x($);Object.values(e).forEach(n=>{const o=n.productId,s=g.find(c=>c.id===o);if(s){const c=s.priceCents*n.quantity;t+=c,a+=`
